...
TypeScript supports inheritance using the extends keyword. Here's an example: */
...
TypeScript supports polymorphism using the abstract keyword. Here's an example: */
...
// // Output: 50, 28.274333882308138

// ---------------------------------------------- Encapsulation ------------------------------------------------------------------------
/*  Encapsulation is the practice of hiding implementation details and only exposing a public interface. 
TypeScript supports encapsulation using the public, private, and protected keywords. Here's an example: */
